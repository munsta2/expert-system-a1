...
def course_material_window():
    text = [[sg.Text("what is your prefered style of course material?")]]
...
def course_length_window():
    text = [[sg.Text("What is your perfered length of lecture length?")]]
